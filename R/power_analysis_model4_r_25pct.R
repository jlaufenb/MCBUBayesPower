...
if(!"power_2surveys_r_25pct" %in% list.files("./output"))
    dir.create("./output/power_2surveys_r_25pct")
if(!"mcmc" %in% list.files("./output/power_2surveys_r_25pct"))
    dir.create("./output/power_2surveys_r_25pct/mcmc")
...
for(rep in batch){
    ...
    print(system.time({
        ...
        file_name <- paste("./output/power_2surveys_r_25pct/mcmc/mcmc_",rep,".RData",sep="")
