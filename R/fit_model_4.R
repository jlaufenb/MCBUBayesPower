...
#'
#' @return  JAGS MCMC output from fitting an exponential growth model with individual birds as observation unit and observer random effect on sigma parameter to MCBU distance-sampling data from 2003 and 2018. Output is saved as an RData file named \code{out4.R}.
#' @export
#'
